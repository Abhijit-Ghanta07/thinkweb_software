    ...
    <section className="py-24 bg-background px-5 dark:bg-gray-900">
      <div className="lg:container mx-auto grid lg:grid-cols-2 gap-14 items-start">
        ...
        <motion.form
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.4 }}
          className="space-y-5 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow"
        >
          <Input
            placeholder="Your Name"
            className="h-12 bg-gray-100 dark:bg-gray-700 border-none"
          />
          ...
          <Textarea
            ...
            className="h-32 bg-gray-100 dark:bg-gray-700 border-none"
          />
