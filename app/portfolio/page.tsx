...
export const metadata = generateSEO({
  title: `Portfolio | ${siteInfo.name}`,
  description: "Client success stories & projects we delivered.",
});
export default function page() {
  return (
    <>
      <Script id="breadcrumbs-portfolio" type="application/ld+json">
        {JSON.stringify({
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  ...
                  <div className="flex flex-col gap-4 group">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-[#616f89] dark:text-gray-400 text-sm font-normal leading-normal">
                        A cross-platform social networking app for iOS and
                        Android focused on real-time connections.
                      </p>
                      <div className="flex flex-wrap gap-2 pt-1">
                        <span className="text-xs font-medium text-primary bg-primary/20 dark:bg-primary/30 dark:text-blue-200 rounded-full px-2.5 py-1">
                          React Native
                  ...
                  <div className="flex flex-col gap-4 group">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-[#616f89] dark:text-gray-400 text-sm font-normal leading-normal">
                        An enterprise-level data visualization tool for
                  ...
                  <div className="flex flex-col gap-4 group">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-[#616f89] dark:text-gray-400 text-sm font-normal leading-normal">
                        A motivational fitness app for tracking workouts,
                        setting goals, and sharing progress.
                      </p>
                      <div className="flex flex-wrap gap-2 pt-1">
                        <span className="text-xs font-medium text-primary bg-primary/20 dark:bg-primary/30 dark:text-blue-200 rounded-full px-2.5 py-1">
                          Swift
