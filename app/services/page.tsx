...
export const metadata = generateSEO({
  title: `Services | ${siteInfo.name}`,
  description:
    "Web development, Mobile app development, SEO & branding services.",
});
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Yes, we build cross-platform apps.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Most projects take 2–8 weeks.",
              },
            },
          ],
        })}
                      ...
                      <div className="flex items-start gap-6">
                        ...
                        <div>
                          ...
                          <p className="mt-2 text-sm">
                            ...
                            project requirements to create a detailed roadmap
                            for success.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-6 md:self-end md:flex-row-reverse md:text-right">
                        ...
                        <div>
                          ...
                          <p className="mt-2 text-sm">
                            ...
                            interactive prototypes to visualize the final
